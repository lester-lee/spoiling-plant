			...
			working_visualisations = {
				{
					...
					animation = {
						...
						stripes = {
							{
								filename = "__spoiling-plant__/graphics/entity/spoiling-plant/spoiling-plant-emission-1.png",
								width_in_frames = 8,
								height_in_frames = 8,
							},
							{
								filename = "__spoiling-plant__/graphics/entity/spoiling-plant/spoiling-plant-emission-2.png",
								width_in_frames = 8,
								height_in_frames = 2,
							},
						},
